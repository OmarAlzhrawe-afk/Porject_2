...
<form method="POST" action="{{ route('admin.process.update_PublicContent') }}" enctype="multipart/form-data">
    @csrf
    <input type="number" name="content_id" value="{{$public_content_id}}" hidden>
